...
MapDialog::MapDialog(QWidget *parent) : QDialog(parent)
{
    ...
    int fileDirLength = appDirPath.lastIndexOf ("/");
    QString fileDir = appDirPath.right( appDirPath.length() - fileDirLength - 1 );
    QString appUpDirPath = appDirPath.left( appDirPath.length() - fileDir.length() - 1 );
